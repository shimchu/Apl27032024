...
This repository consists of all my Python coded implementations to the challenging problem statements of the assignments in the course EE2703 under Professor Nitin Chandrachoodan at the Indian Institute of Technology, Madras.

 Every directory consists of 
 - a README file describing the problem statement and my approach
 - A report consisting a detailed analysis of my implmentations, inferences of the results and solutions to bonus questions
...
## <u> Course Overview 
The course was designed to build strong programming fundamentals while applying computational techniques to real-world electrical and electronic engineering problems.
...
- A **strong foundation in Python programming and computational thinking**
- The ability to **apply numerical and optimization methods to real EE problems**
- Hands-on experience in **algorithm implementation, data analysis, and performance tuning**
